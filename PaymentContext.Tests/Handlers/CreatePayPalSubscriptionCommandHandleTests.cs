...
public class CreatePayPalSubscriptionCommandHandleTests {

    private static CreatePayPalSubscriptionCommand ValidCommand() => new() {
        PayPalEmail = "paypal@gmail.com",
        PayPalTransactionCode = "T1234567890123456",
